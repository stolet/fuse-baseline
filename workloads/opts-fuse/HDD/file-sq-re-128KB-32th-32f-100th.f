...
system "/home/stolet/fuse-3.7.0/example/stackfs_ll --statsdir=/tmp/ -o max_write=131072 -o writeback_cache -o splice_read -o splice_write -o splice_move -r /home/stolet/COM_DIR/EXT4_FS/ /home/stolet/COM_DIR/FUSE_EXT4_FS/ > /dev/null &"

system "sleep 2"

#Increase the number of user threads to 100
system "echo 100 > /sys/fs/fuse/connections/`stat --format '%d' /home/stolet/COM_DIR/FUSE_EXT4_FS/`/max_background"
